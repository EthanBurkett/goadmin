              ...
              <Card key={cmd.id} className={!cmd.enabled ? "opacity-50" : ""}>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <span className={`text-sm ${getPowerColor(cmd.minPower)}`}>
                      Power: {cmd.minPower}
                    </span>
                  </div>
                  {cmd.permissions &&
          ...
          <DialogContent className="max-w-2xl">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <Label htmlFor="edit-minPower">Min Power Level (0-100)</Label>
                  <Input
                    id="edit-minPower"
                    type="number"
                    min="0"
              ...
              <div>
                <Label htmlFor="edit-rconCommand">RCON Command Template</Label>
                <Input
                  id="edit-rconCommand"
                  value={formData.rconCommand}
                  onChange={(e) =>

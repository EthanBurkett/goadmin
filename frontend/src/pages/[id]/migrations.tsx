        ...
        <Card>
          ...
          <CardContent className="flex gap-3">
            <Button
              onClick={handleApply}
              disabled={
                applyMigrations.isPending || (status?.total_pending || 0) === 0
              }
              className="gap-2"
            >
                  ...
                  >
                    <div className="space-y-1">
                      ...
                      {migration.applied_at && (
                        <p className="text-xs text-muted-foreground">
                          Applied{" "}
                          {formatDistanceToNow(new Date(migration.applied_at), {
                            addSuffix: true,
                          })}
                        </p>
                      )}
        ...
        <Card className="border-red-500/50 bg-red-500/10">
          <CardHeader>
            ...
            <CardDescription>
              ...
              migrations. Rollback operations are destructive and may result in
              data loss. Test migrations in a development environment first.
            </CardDescription>
          </CardHeader>
        </Card>
      </div>
